...
public class HotelService {
    ...
    public List<Hotel> buscar(String nombre, Integer categoriaMinima, String domicilio, Boolean cerrado, Amenity amenity) {
    ...
    public Hotel agregarAmenities(Integer hotelId, List<Amenity> amenities) {
        ...
        amenities.forEach(amenity -> {
            if (amenityHotelRepository.findByHotelIdAndAmenity(hotelId, amenity).isEmpty()) {
                amenityHotelRepository.save(AmenityHotel.builder().hotel(hotel).amenity(amenity).build());
            }
        });
    ...
    public void quitarAmenity(Integer hotelId, Amenity amenity) {
        AmenityHotel amenityHotel = amenityHotelRepository.findByHotelIdAndAmenity(hotelId, amenity)
