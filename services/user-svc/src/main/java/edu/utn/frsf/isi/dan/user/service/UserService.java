...
public class UserService {
  ...
  public void crearUsuarioPropietario(PropietarioRecord propietarioRecord) {
    // Buscar el banco por ID
    Optional<Banco> bancoOptional =
        bancoRepository.findById(propietarioRecord.cuentaBancaria().idBanco());
    if (bancoOptional.isEmpty()) {
      throw new IllegalArgumentException(
          "Banco no encontrado con ID: " + propietarioRecord.cuentaBancaria().idBanco());
    }
