...
public class UserControllerTest {
  ...
  public void testCrearUsuarioPropietario() throws Exception {
    ...
    CuentaBancariaRecord cuentaBancariaRecord =
        new CuentaBancariaRecord("123456789", "BankName", "BranchName", 1);
    PropietarioRecord propietarioRecord =
        new PropietarioRecord(
            "John Doe",
